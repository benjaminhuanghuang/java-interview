...
public class TwoSumTest {
    ...
    public void shouldReturnRightValue() throws Exception {
        int[] actual = LC_001_TwoSum.solve(new int[]{2, 7, 11, 15}, 9);
    ...
    public void shouldReturnRightValue2() throws Exception {
        int[] actual = LC_001_TwoSum.solve2(new int[]{2, 7, 11, 15}, 9);
    ...
    public void shouldReturnZero() throws Exception {
        int[] actual = LC_001_TwoSum.solve(new int[]{2, 7, 11, 15}, 100);
