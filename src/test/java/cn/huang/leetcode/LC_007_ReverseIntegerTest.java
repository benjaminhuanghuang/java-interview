...
public class LC_007_ReverseIntegerTest {
    @Test
    public void noChange() throws Exception {

        int actual = LC_007_ReverseInteger.reverse(11111);
    ...
    public void shouldReversePositiveNum() throws Exception {
        int actual = LC_007_ReverseInteger.reverse(123);
    ...
    public void shouldReverseNumEndWithZero() throws Exception {
        int actual = LC_007_ReverseInteger.reverse(120);
